    ...
    <div class="card mb-5">
        <div class="card-body p-5">
            <div class="d-flex gap-5">
                <div class="col">
                    <label for="" class="form-label">Kategori Motor</label>
                    ...
                    <label for="" class="form-label">Tipe Motor</label>
                    ...
                    <div class="mb-3"> 
                        <label class="form-label">Nomor Polisi Motor:</label>
                        <input type="text" wire:model='nomor_polisi' class="form-control" placeholder="Masukkan plat nomor motor Anda" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
                    </div>
                    <div>
                ...
                <div class="col">
                    ...
                    <div class="d-flex gap-5 mb-3">
                        @if (in_array('1', $selectedRepaints) || in_array('2', $selectedRepaints) || in_array('3', $selectedRepaints))
                            <div>
                                <label for="" class="form-label">Unggah Foto Motor</label>
                                <input type="file" wire:model='foto_motor' class="form-control">
                            </div>
                        @endif
                        @if (in_array('4', $selectedRepaints))
                            <div >
                                <label for="foto_velg" class="form-label">Unggah Foto Velg:</label>
                    ...
                    @if ($selectedRepaints)                        
                    <p class="fst-italic text-danger"><i class="bi bi-info-circle me-2"></i>Untuk keakuratan warna, tulis warna
                    ...
                    @endif
                        ...
                        <button type="button" class="btn btn-success fw-bold w-100" wire:click="reservasi" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <p>Reservasi Tersimpan: {{ $reservasiTersimpan ? 'Ya' : 'Tidak' }}</p>
                    </div>
                    @endif --}}
