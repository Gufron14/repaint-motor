...
@if (in_array($item->status, ['batal', 'tolak']))
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        <img src="{{ asset('storage/' . $buktiPengembalian) }}" alt="Bukti"
    ...
    @else
        {{-- Status batal/tolak tapi belum ada bukti --}}
        <div class="alert alert-info text-center" role="alert">
            Permintaan telah <strong>{{ $item->status }}</strong>. Pengembalian Dana akan dikirim ke <strong>{{ $item->user->no_rek }}</strong> dalam waktu kurang lebih 24 Jam.
        </div>
    @endif

@elseif (!in_array($item->status, ['selesai']))
    {{-- Status lain (belum selesai/belum batal/tolak) --}}
    <div class="alert alert-info text-center" role="alert">
